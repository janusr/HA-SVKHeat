...
def get_entities_by_platform(platform: str) -> List[str]:
    ...
    return [key for key, entity in ENTITIES.items() if entity.get("platform") == platform]

def get_entities_by_category(category: str) -> List[str]:
    """Return entity keys for a specific category."""
    return [key for key, entity in ENTITIES.items() if entity.get("category") == category]
